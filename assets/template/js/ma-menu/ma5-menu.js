...
function ma5menu(atributes) {
    ...
    if ($(menuDesktop).length > 0) {
        var ma5menuHtml = '\n' +
            ...
            '           <span class=""><img class="logo logo-sena__header" src="./assets/template/images/logo-sena.svg" alt="Logo: SENA, Servicio Nacional de Aprendizaje"></span>\n' +
            '        </a>\n' +
...
function ma5menuBuilder_buildLevels(parent, level, order) {
    ...
    children.each(function () {
        ...
        if (sublist.length > 0) {
            ...
            $(this).find('> ul > li:first-child').prepend('<div class="ma5menu__leave"><i class="bi bi-chevron-left"></i><span class="this-text">' + thisText + '</span></div>');
